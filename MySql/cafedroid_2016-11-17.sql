...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2016 at 07:52 PM
...
-- Database: `cafedroid`
--
CREATE DATABASE IF NOT EXISTS `cafedroid` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cafedroid`;
...
(1, 58, 275, '2016-11-17 14:34:22', 1);
...
(27, 51, 1, 1, 'Title2', 'Where is the number seven.pdf', 'phpD97E.tmp'),
...
(45, 55, NULL, 8, 'The History of Stuff', 'www.eaglerockreservation.org_ERRCMAP_Jan09.pdf', 'php22C2.tmp'),
(46, 58, 1, 17, 'Title 1', 'Where is the number seven.pdf', 'php6752.tmp'),
(47, 58, 1, 22, 'Title 2', 'Where is the number seven.docx', 'php1A2D.tmp');
...
(25, 17, 'AVR Programming: Lea', 'Atmel''s AVR microcontrollers are the chips that power Arduino, and are the go-to chip for many hobbyist and hardware hacking projects. In this book you''ll set aside the layers of abstraction provided by the Arduino environment and learn how to program AVR ', 14, '1479355109.jpeg'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Users of the WA Web App' AUTO_INCREMENT=59 ;
...
(1, '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Kevin', 'Miller', 'company', '123 Main', 'Add line 2', 'MyCityGood', 'KY', '12345', '1234567890', 'ksmiller99@gmail.com', 1, 1, 0, 1, 0),
(20, '2aa60a8ff7fcd473d321e0146afd9e26df395147', 'Kevin', 'Miller-Yiu', 'Comp', 'Add1', 'Add2', 'Mycity', 'MY', '12345', '1234567890', 'neither@ab.com', 1, 1, 1, 1, 1),
(44, '2aa60a8ff7fcd473d321e0146afd9e26df395147', 'Kevin', 'Jonesy', 'Big', 'a1', 'a2', 'city', 'KY', '12345', '1234567890', 'hj@8.g', 1, 0, 0, 0, 1),
(46, '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Bob', 'Riffer', 'Comp', 'Add1', '', '', '', '', '', 'a@a.a', 0, 0, 0, 0, 0),
...
(55, '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Cafedroid1', 'Admin', 'CafeDroid', '123 Elm. St.', '10F', 'Berlin', 'KY', '12345', '1234567890', 'cafedroid1@work.com', 1, 0, 0, 1, 0),
(56, '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Cafedroid2', 'Student', 'Cafedroid', 'One Wall St', '23rd Fl', 'New York', 'NY', '10001', '1234567890', 'cafedroid2@work.com', 0, 0, 0, 1, 0),
(57, '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Cafedroid3', 'Author', 'BigCompany', '99 University Pl', '', 'Miami', 'OH', '12345', '5663224321', 'cafedroid3@work.com', 0, 0, 0, 0, 0),
(58, '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'John', 'Does', '', '123 elm', '', 'A City', 'NY', '12345', '1234567890', 'john@work.com', 0, 1, 1, 1, 0);
