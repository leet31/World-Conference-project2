...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-11-15 19:29:32
-- 服务器版本： 5.6.20
-- PHP Version: 5.5.15
...
ALTER TABLE `wa_order_details`
 ADD PRIMARY KEY (`ORDER_ID`,`PRODUCT_ID`), ADD KEY `ORDER_DETAILS_PRODUCT_ID` (`PRODUCT_ID`);
